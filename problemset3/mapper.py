...
#            print(sublist)
            if(len(sublist)!=0):
#                print("epsilon graph clusters")
#                print(epsilon_graph_clusters(sublist, alpha))
...
#            print(i)
#            print(cluster)
#        test1=ALL_CLUSTERS[2]
#        test1=[item for sublist in test1 for item in sublist]
#        test1=[tuple(l) for l in test1]
#        test1=tuple(test1)
#        test2=ALL_CLUSTERS[3]
#        test2=[item for sublist in test2 for item in sublist]
#        test2=[tuple(l) for l in test2]
#        test2=tuple(test2)
#        if (not set(test1).isdisjoint(set(test2))):
